...
get_arn() {
  ...
  local FILEPATH="/mnt/d/NB27771/ARCH/aws-login/aws-mfa-arns"
  local arn
...
main() {
  ...
  MFA_TOKEN_CODE="$1"
  AWS_ROLE_PROFILE="opsmon-mfa"
  ROLE_ARN="arn:aws:iam::445137467319:role/InfraTerraform"
  ROLE_SESSION_NAME="InfraTerraformSession"
